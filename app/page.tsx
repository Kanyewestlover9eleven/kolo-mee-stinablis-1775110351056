...
const basePath = '/kolo-mee-stinablis-1775110351056';
...
export default function Home() {
  ...
  const products = [{ n: 'Kolo Putih', d: 'Our Kolo Putih is a traditional kolo mee dish made with fresh ingredients and a special blend of spices, served with a side of delicious chilli sauce. This signature dish is a must-try for any kolo mee lover.', i: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=600&q=80', icon: 'domain' }, { n: 'Kolo Merah', d: 'Our Kolo Merah is a variation of the traditional kolo mee, with a spicy kick from our special merah sauce. This dish is perfect for those who like a little heat in their meal.', i: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600&q=80', icon: 'architecture' }, { n: 'Kolo Kicap', d: 'Our Kolo Kicap is a unique fusion of kolo mee and kicap manis, creating a sweet and savory flavor profile that is sure to delight. This dish is a favorite among our regular customers.', i: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=600&q=80', icon: 'chair' }, { n: 'Wantan', d: 'Our Wantan is a delicious and savory dumpling filled with pork or chicken, served in a light broth or stir-fried with vegetables. This dish is a great accompaniment to our kolo mee dishes.', i: 'https://images.unsplash.com/photo-1504639725590-34d0984388bd?w=600&q=80', icon: 'eco' }, { n: 'Mee Pok', d: 'Our Mee Pok is a classic noodle dish made with flat egg noodles, served in a light broth or stir-fried with vegetables and your choice of protein. This dish is a staple in our restaurant and a favorite among our customers.', i: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=600&q=80', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Kolo mee stinablis, we are dedicated to serving the best kolo mee in town, with a focus on quality ingredients and traditional recipes. Our team is passionate about creating an exceptional dining experience for our customers. With a commitment to excellence and a passion for food, we strive to be the go-to destination for kolo mee lovers.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To be the leading provider of delicious and authentic kolo mee, while promoting a culture of excellence and customer satisfaction.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To serve the best kolo mee in town, using only the freshest ingredients and traditional recipes, while providing exceptional customer service and building a loyal community of customers.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">haha</h4>
                  <p className="text-sm text-on-surface-variant">At Kolo mee stinablis, our first core value \'haha\' represents our commitment to creating a fun and enjoyable dining experience for our customers, by providing a welcoming atmosphere and exceptional service.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">lmao</h4>
                  <p className="text-sm text-on-surface-variant">Our second core value \'lmao\' represents our dedication to continuous improvement and innovation, ensuring that our menu and services stay ahead of the curve and exceed customer expectations.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              ...
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=600&q=80" alt="About 2" className="w-full h-full object-cover" />
              </div>
